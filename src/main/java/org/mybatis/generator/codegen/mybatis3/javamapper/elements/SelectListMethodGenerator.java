...
public class SelectListMethodGenerator extends
    ...
    public void addInterfaceElements(Interface interfaze) {
        ...
        newArrayListInstance.addTypeArgument(returnType);
        interfaze.addImportedType(newArrayListInstance);
        FullyQualifiedJavaType list = new FullyQualifiedJavaType("List");
        list.addTypeArgument(returnType);
        method.setReturnType(list);
        method.setName(GeneratorMethod.selectList.getValue());
